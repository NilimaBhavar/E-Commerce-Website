...
const emptyForm: ProductForm = {
  name: "", description: "", price: "", originalPrice: "", categoryId: "", brand: "", stock: "", imageUrl: "", isFeatured: false,
};
...
export function AdminProductsPage() {
  ...
  function openEdit(p: { id: number; name: string; description?: string | null; price: number; originalPrice?: number | null; categoryId?: number | null; brand?: string | null; stock: number; imageUrl: string; isFeatured: boolean }) {
    setEditingId(p.id);
    setForm({
      name: p.name, description: p.description ?? "", price: String(p.price),
      originalPrice: p.originalPrice ? String(p.originalPrice) : "",
      categoryId: p.categoryId ? String(p.categoryId) : "",
      brand: p.brand ?? "", stock: String(p.stock), imageUrl: p.imageUrl, isFeatured: p.isFeatured,
    });
    setDialogOpen(true);
  }
  ...
  function handleSave() {
    const data = {
      ...
      brand: form.brand, stock: Number(form.stock), imageUrl: form.imageUrl,
  ...
  const field = (key: keyof ProductForm, label: string, props: React.InputHTMLAttributes<HTMLInputElement> = {}) => (
    <div>
