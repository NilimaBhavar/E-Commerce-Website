...
import { useGetCart } from "@/hooks/useApi";
...
export function Navbar() {
  ...
  return <header className="sticky top-0 z-50 bg-white border-b border-border shadow-sm">
    ...
    /* Logo */
          ...
          <Link href="/" className="flex items-center gap-2 shrink-0">
            ...
            <span className="text-xl font-bold text-foreground">
              Tara<span className="text-primary">Shop</span>
            </span>
          </Link>
  ...
  />
    ...
    /* Desktop nav */
          ...
          <nav className="hidden md:flex items-center gap-1 ml-auto">
            ...
            {isAuthenticated && <Link href="/wishlist" className="p-2 text-foreground hover:text-primary transition-colors" data-testid="link-wishlist">
            ...
            <Link href="/cart" className="relative p-2 text-foreground hover:text-primary transition-colors" data-testid="link-cart">
              ...
              {isAuthenticated && cartCount > 0 && <Badge className="absolute -top-1 -right-1 h-5 w-5 p-0 flex items-center justify-center text-xs bg-primary text-primary-foreground">
    ...
    /* Mobile icons */
          ...
          <div className="flex md:hidden items-center gap-2 ml-auto">
            <Link href="/cart" className="relative p-2">
              <ShoppingCart className="h-5 w-5" />
              {isAuthenticated && cartCount > 0 && <Badge className="absolute -top-1 -right-1 h-4 w-4 p-0 flex items-center justify-center text-xs bg-primary">
                  {cartCount}
                </Badge>}
            </Link>
    ...
    /* Mobile menu */
        ...
        {mobileOpen && <div className="md:hidden border-t border-border py-4 space-y-3">
