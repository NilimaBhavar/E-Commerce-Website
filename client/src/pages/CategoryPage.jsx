...
import { useListCategories } from "@/hooks/useApi";
...
export function CategoryPage() {
  ...
  return <div className="container mx-auto px-4 py-10">
      ...
      {isLoading ? <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
          {Array.from({ length: 12 }).map((_, i) => <Skeleton key={i} className="h-48 rounded-xl" />)}
        </div> : <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
