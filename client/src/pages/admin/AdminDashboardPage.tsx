...
export function AdminDashboardPage() {
  ...
  const statCards = [
    ...
    { label: "Total Revenue", value: stats?.totalRevenue ? `₹${Number(stats.totalRevenue).toLocaleString("en-IN")}` : undefined, icon: IndianRupee, color: "text-green-600", bg: "bg-green-50" },
  ];
